...
ax_yScale = 'log'
xLims = (-4.5, 0.0)
yLims = (9.000000000000001e-09, 11.0)
...
exec(open(prefix+'zjets_ungroomed_pt1__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'zjets_ungroomed_pt1.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'zjets_ungroomed_pt1.png'), format='PNG')
