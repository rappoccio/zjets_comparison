...
# Analysis object: /CMS_2026_PAS_SMP_25_010/zjets_ungroomed_pt0
...
ax_yScale = 'linear'
xLims = (-4.5, 0.0)
yLims = (-0.0009853960600000001, 1.2918906000000001)
...
exec(open(prefix+'zjets_ungroomed_pt0__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'zjets_ungroomed_pt0.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'zjets_ungroomed_pt0.png'), format='PNG')
