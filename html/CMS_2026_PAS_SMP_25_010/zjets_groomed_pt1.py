...
exec(open(prefix+'zjets_groomed_pt1__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'zjets_groomed_pt1.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'zjets_groomed_pt1.png'), format='PNG')
