...
# Analysis object: /CMS_2026_PAS_SMP_25_010/zjets_groomed_pt2
...
exec(open(prefix+'zjets_groomed_pt2__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'zjets_groomed_pt2.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'zjets_groomed_pt2.png'), format='PNG')
