...
exec(open(prefix+'zjets_groomed_pt0__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'zjets_groomed_pt0.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'zjets_groomed_pt0.png'), format='PNG')
